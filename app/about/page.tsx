        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
              پرسینو با هدف ایجاد یک تحول جدی در شیوه‌ی درس خواندن دانش‌آموزان شکل گرفت. ما می‌خواهیم هوش مصنوعی را از ابزار صرف، به یک همراه واقعی در مسیر یادگیری تبدیل کنیم. هدف پرسینو این است که هر دانش‌آموز، بدون نیاز به کلاس خصوصی یا مشاور گران‌قیمت، به یک برنامه‌ریزی دقیق، آموزش هوشمند و پاسخ‌دهی فوری دسترسی داشته باشد. ما در تلاشیم یادگیری را شخصی‌سازی‌شده، مقرون‌به‌صرفه و همیشه در دسترس کنیم.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
