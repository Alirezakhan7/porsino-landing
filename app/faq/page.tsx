...
const faqs = [
  {
    ...
    answer: "پرسینو یک پلتفرم هوش مصنوعی کنکوری است که به عنوان دستیار شخصی درسی به دانش‌آموزان کمک می‌کند. این سامانه با تحلیل سطح علمی، نقاط ضعف و سبک یادگیری هر دانش‌آموز، پاسخ‌های دقیق ارائه می‌دهد، نمونه سوال می‌سازد، برنامه‌ریزی درسی می‌کند و آموزش‌های گام‌به‌گام را در اختیار قرار می‌دهد."
  },
  {
  ...
  },
  {
    ...
    answer: "پشتیبانی در پرسینو به‌صورت ۲۴ ساعته و در تمام روزهای هفته فعال است. کاربران می‌توانند از طریق چت آنلاین در سایت، ایمیل یا کانال تلگرام رسمی پرسینو سوالات خود را مطرح کرده و پاسخ‌های دقیق و سریع دریافت کنند. تیم ما همیشه آماده کمک‌رسانی است."
  },
  {
